    ...
    public static void main(String[] args) throws IOException{
        ...
        while(true){
            ...
            while(true){// as long as client sends expression, server will evaluate until exit is sent
                ...
                int result=Server.calculate(exp);//evaluating the result for the given expression

                out.println("Evaluated result from server "+result);//sending the result back to the client
            }
